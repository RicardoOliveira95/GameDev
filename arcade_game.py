...
class SpaceShooter(arcade.Window):
    ...
    def on_update(self, delta_time: float):
        ...
        if self.collided:
            #print("HEALTH: ",self.health,", timer: ",self.collision_timer)
    ...
    def on_draw(self):
        ...
        if self.gameover:
            file1=open("C:/Users/ricar/PythProjs/arc/highscores.txt",'w')
            sc=str(int(self.score))
            print("GAME OVER: "+sc)
            file1.write(sc)
            file1.close()
            #return
        ...
        #draw health
        arcade.draw_rectangle_filled(SCREEN_WIDTH-90, SCREEN_HEIGHT-10, self.health,10, arcade.color.AZURE)
        arcade.draw_text("SCORE:"+str(int(self.score)),SCREEN_HEIGHT-20,10,arcade.color.BLACK,width=20,align='center')
        self.all_sprites.draw()
            
        if self.paused:
            arcade.draw_text("PRESS P TO PLAY",SCREEN_WIDTH/2-10,SCREEN_HEIGHT/2-10,arcade.color.BLACK,width=50,align='center')
